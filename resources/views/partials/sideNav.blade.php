        ...
        <nav class="sidenav shadow-right sidenav-light">
            <div class="sidenav-menu">
                <div class="nav accordion" id="accordionSidenav">
                    ...
                    <div class="collapse" id="collapsePagesAdmin" data-bs-parent="#accordionSidenavNext1">
                    ...
                    <div class="collapse" id="collapsePagesPara" data-bs-parent="#accordionSidenavNext2">
                        <nav class="sidenav-menu-nested nav">
                    ...
                    <div class="collapse" id="collapsePages" data-bs-parent="#accordionSidenavNext3">
                        <nav class="sidenav-menu-nested nav">
                    ...
                    <div class="collapse" id="pagesCollapseErrorEB" data-bs-parent="#accordionSidenavNext4">
                        <nav class="sidenav-menu-nested nav">
                    ...
                    <div class="collapse" id="pagesCollapseErrorST" data-bs-parent="#accordionSidenavNext5">
                        <nav class="sidenav-menu-nested nav">
